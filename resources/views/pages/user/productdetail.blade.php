			...
			<div class="span9">
				<div class="row">
					...
					<div class="span5">
						...
						<h4><strong>Price: Rp. 99.999</strong></h4>
					</div>
					<div class="span5">
				...
				<div class="row">
					<div class="span9">
						...
						<div class="tab-content">
							<div class="tab-pane active" id="home">Bahan yang lembut dan juga sangat nyaman digunakan , membuat musim panas menjadi lebih bermakna dengan fasion yang elegan dan juga menarik Dan hampir setiap musim diberikan dalam mode, jenis baru dari gaya klasik dalam pakaian.Hari ini, banyak dari mereka, tetapi mereka mempertahankan keseimbangan yang indah elegan, kesederhanaan dan bangsawan. pakaian tersebut hampir semua, dan menempatkan mereka dalam lemari pakaian</div>
									...
									<ul class="thumbnails listing-products">
										<li class="span3">
											<div class="product-box">
												...
												<a href="{{ route('productdetail') }}"><img alt="" src="themes/images/ladies/6.jpg"></a><br/>
												<a href="{{ route('productdetail') }}" class="title">Wuam ultrices rutrum</a><br/>
